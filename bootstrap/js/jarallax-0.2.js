    ...
    for(var i = 0; i < values.length - 1; i++){
      if(values[i] && values[i + 1])
      {
        if(values[i]['progress'] && values[i + 1]['progress']) {
          this.animations.push(new JarallaxAnimation(selector, values[i], values[i + 1]));
        }
        else
        {
...
////////////////////////////////////////////////////////////////////////////////
JarallaxAnimation = function (selector, startValues, endValues) {
  this.progress = 0;
  this.selector = selector;
